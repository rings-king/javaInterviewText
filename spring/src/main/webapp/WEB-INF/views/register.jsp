...
<head>
    ...
    <title>注册-个人用户</title>
    <link rel="stylesheet" type="text/css" href="WEB-INF/css/headerfooter.css" />
<link rel="stylesheet" type="text/css" href="WEB-INF/css/jquery.alerts.css" />
<link rel="stylesheet" type="text/css" href="WEB-INF/css/headerfooterindex.css" />
<script type="text/javascript" src="WEB-INF/js/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="WEB-INF/js/jquery.cookie.js"></script>
<script type="text/javascript" src="WEB-INF/js/passport.common.js?v20140531"></script>
<script type="text/javascript" src="WEB-INF/js/jquery.alerts.js"></script>
<script type="text/javascript" src="WEB-INF/js/png.js?v20140521"></script>
</head>
<body>
		<!-- header -->
		<div class="header">
