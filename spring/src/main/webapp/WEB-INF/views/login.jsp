...
<head>
    ...
    <title>登录淘淘</title>
    <link rel="stylesheet" type="text/css" href="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\css\jquery.alerts.css"/>
    <link rel="stylesheet" type="text/css" href="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\css\headerfooterindex.css"/>
    <link rel="stylesheet" type="text/css" href="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\css\login.css"/>
    <script type="text/javascript" src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\js\jquery-1.5.1.min.js"></script>
    <script type="text/javascript" src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\js\jquery.cookie.js"></script>
    <script type="text/javascript" src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\js\jquery.alerts.js"></script>
    <script type="text/javascript" src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\js\png.js"></script>
    <script type="text/javascript" src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\js\cas.login.js"></script>
    <script type="text/javascript" src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\js\capsLock.js"></script>
</head>
<body>
<!-- header -->
<div class="header">
    <a href="http://www.e3mall.cn"><img src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\images\logo.png" border="0"><span>欢迎登录</span></a>
</div>
<!-- login_main -->
<div class="login_main clear">
    <div class="pic">
        <a href="http://www.e3mall.cn/html/activity/1472720729.html" target="_blank"><img
                src="D:\developDemo\javainterviewtext\spring\src\main\webapp\WEB-INF\images\06f42c372620f92b40da77a8b23cdf7f.png"></a>
    </div>
    <!-- login -->
    <div class="login">
        <div class="login_header">
            <span>您还未登录</span>
            <a href="/spring/register">免费注册</a>
        </div>
